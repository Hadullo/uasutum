  ...
  <footer>
    <div class="footer-area">
        <p>© Copyright 2022. All right reserved. Designed by <a href="https://www.uasutum.net/"><span class = "designer">UASU TUM Chapter</span></a></p>
    </div>
</footer>
<!-- footer area end-->
</div>
...
<script src="{{ asset('assets/admin/js/scripts.js') }}"></script>
    ...
    <script src="{{ asset('assets/admin/plugins/imgCrop/ijaboCropTool.min.js') }}"></script>
...
@endif
      ...
      <!-- Sweet Alert Delete with confirmation-->
