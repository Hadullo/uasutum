...
@section('content')
  ...
  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg"><h5>Create a News Item</h5></p>
    ...
    <form  method = "POST" action = "{{ route('news.store') }}"   enctype="multipart/form-data" >
        ...
        <div class="input-group mb-3">
            <input type="text" name = "newsPhotoCaption"  class="form-control" id= "newsPhotoCaption"  placeholder="News Photo Caption">
            <div class="input-group-append">
              <div class="input-group-text">
              </div>
            </div>
        ...
        <div class="input-group mb-3">
          ...
          <textarea class="form-control" id="body" name = "body" rows="3"   placeholder="News Content" value = "{{ old('body') }}"></textarea>
          <div class="input-group-append">
            <div class="input-group-text">
            </div>
          </div>
