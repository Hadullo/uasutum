            ...
            <table class="table table-borderless">
                <thead>
                    ...
                    <tr>
                        ...
                        <td><h1>Edit a Chapter Report</h1></td>
                        ...
                        <div class="product-categorie-box">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    ...
                                    <div class= "my-heading">Fill the Form to Edit a Report</div>
                                        ...
                                        <form  method = "POST" action = "{{ route('report.update', $report) }}"   enctype="multipart/form-data" >
                                           @method('put')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="body" name = "body" rows="3"   placeholder="Body Text" name = "body">{{ $report->body }}</textarea>
                                            </div>
